	 ...
	 var g = function() {
		if (c.length && e < a.howManyToShow){
			...
			.then((res) => {
				...
				const productContentCard = htmlDocument.documentElement.querySelector(".product-content-card",h);
				const productCard = htmlDocument.documentElement.querySelector(".product-card",h);
				const searchAble = productCard && productCard.getAttribute("data-searchable") === "true";
				if (searchAble)	$(".js-product-recent",h).append(productContentCard.outerHTML);
				if (c.length > 0) {
